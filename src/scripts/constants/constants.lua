...
Constants.urls = {bootstrap = 'bootstrap', game_scene = 'game_scene'}

Constants.fonts = {Dosis = {id = 'Dosis', Bold = 'Dosis30-Bold'}}

Constants.msg = {
    acquire_input_focus = hash('acquire_input_focus'),
    collision_response = hash('collision_response'),
    screen = {resize = hash('_screen_resized')},
    game_loaded = hash('game_loaded'),
    localization_change = hash('localization_change'),
    sounds = {_play_sound = hash('_play_sound'), _stop_sound = hash('_stop_sound'), _pause_sound = hash('_pause_sound')},
    appbars = {appbar_button_click = hash('appbar_button_click')},
    popups = {popup_closed = hash('popup_closed')},
    add_action = hash('add_action'),
    themes_unlocked = hash('themes_unlocked'),
    undo_action = hash('undo_action'),
    redo_action = hash('redo_action'),
    localization = {_lang_changed = hash('_lang_changed'), language_changed = hash('language_changed')},
    ads = {
    ...
    themes = {_unlocked_emit_msg = hash('_themes_unlocked_emit'), preview_end = hash('theme_preview_end')},
    js = {
    ...
    feedback = {feedback_close = hash('feedback_close'), feedback_accept = hash('feedback_accept')},
    rating_popup = {leaderboard_loaded = hash('rating_popup_leaderboard_loaded')},
}

Constants.actions = {click = hash('click')}
