...
function M.leaderboards_get_description(cb_id)
    M.send(cb_id, NO_ERR)
end

function M.leaderboards_get_player_entry(cb_id)
    M.send(cb_id, NO_ERR)
end

function M.leaderboards_set_score(cb_id)
    M.send(cb_id, NO_ERR)
end

function M.leaderboards_get_entries(cb_id)
    M.send(cb_id, NO_ERR)
end
